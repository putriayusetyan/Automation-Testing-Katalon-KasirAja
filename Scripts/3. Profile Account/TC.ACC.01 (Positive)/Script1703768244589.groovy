...
WebUI.setText(findTestObject('Login/email_form'), 'ateez@store.com')

WebUI.setEncryptedText(findTestObject('Login/password_form'), 'qftuhYKdXqogXEXuOW3eDQ==')
...
WebUI.setText(findTestObject('Profile_Acc/nama_form'), 'sumber makmur store')
...
WebUI.setEncryptedText(findTestObject('Profile_Acc/password_form'), 'IL3RhyMg9Yg=')

WebUI.click(findTestObject('Profile_Acc/simpan_button'))

WebUI.waitForElementVisible(findTestObject('User/title_user'), 20)
